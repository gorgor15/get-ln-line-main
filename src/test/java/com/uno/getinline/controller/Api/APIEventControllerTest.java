...
class APIEventControllerTest {
    ...
    void givenNothing_whenRequestPlaces_thenReturnsListOfPlacesInStandardResponse() throws Exception{
        ...
        mvc.perform(get("/api/events"))
                ...
                .andExpect(jsonPath("$.data[0].eventStatusDatetime").value(LocalDateTime
                        .of(2021,1,1,13,0,0)
    ...
    @DisplayName("[API][GET] 단일 이벤트 조회 - 이벤트 있는 경우, 이벤트 데이터를 표준 API 출력")
    @Test
    void givenNothin_whenRequestPlaces_thenReturnsListOfPlacesInStandardResponse() throws Exception{
        //given
        long eventId = 1L;
        //when & then
        mvc.perform(get("/api/events/"+eventId))
                ...
                .andExpect(jsonPath("$.data.eventStatusDatetime").value(LocalDateTime
                        .of(2021,1,1,13,0,0)
                        .format(DateTimeFormatter.ISO_LOCAL_DATE_TIME)))
    ...
    @DisplayName("[API][GET] 단일 이벤트 조회 - 이벤트 없는 경우, 빈 표쥰 API 출력")
    @Test
    void givenEventID_whenRequestingNonexisEvent_thenReturnsEmptyStandardResponse() throws Exception{
        //given
       long eventId = 2L;
        //when & then
        mvc.perform(get("/api/events/"+eventId))
    ...
    @Test
    void givenEvent_whenPutEvent_thenReturnsSuccessStandardResponse() throws Exception{
        //given
        long eventId = 1L;
        //given
        EventResponse eventResponse = EventResponse.of(
    ...
    @Test
    void givenEvent_whenDeleteEvent_thenReturnsSuccessStandardResponse() throws Exception{
        //given
        long eventId = 1L;
        //when & then
